...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            name='coupon_use',
            field=models.BooleanField(default=False, verbose_name='사용여부'),
        ),
        migrations.AddField(
        ...
        migrations.AlterField(
            model_name='coupon_sort_info',
            name='serial_num',
            field=models.PositiveIntegerField(default=0, primary_key=True, serialize=False, verbose_name='일련번'),
        ),
        migrations.AlterField(
