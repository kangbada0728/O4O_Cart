  ...
  public Result[] decodeMultiple(BinaryBitmap image, Map<DecodeHintType,?> hints) throws NotFoundException {
    ...
    for (DetectorResult detectorResult : detectorResults) {
      try {
        ...
        float tempx, tempy;
        tempx =points[0].getX() +  (points[2].getX() - points[0].getX())/2;
        tempy =points[0].getY() + (points[2].getY() - points[0].getY())/2;
        /*
        System.out.print("CAM1 DETECT:");
        for(int i =0; i< 3; i++) {
        ...
        System.out.print("	|좌표 ");
        System.out.print((int)tempx);
        System.out.print(", ");
        System.out.println((int)tempy);
        */
        QRCode.getInstance().setLocation((int)tempx, (int)tempy);
