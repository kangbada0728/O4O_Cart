# Generated by Django 2.0.4 on 2018-05-18 13:18
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='ad_info',
            name='num',
            field=models.AutoField(default=1, primary_key=True, serialize=False, verbose_name='번호'),
        ),
        migrations.AlterField(
            model_name='camera_info',
            name='num',
            field=models.AutoField(default=1, primary_key=True, serialize=False, verbose_name='카메라 번호'),
        ),
        migrations.AlterField(
            model_name='cart_info',
            name='num',
            field=models.AutoField(default=1, primary_key=True, serialize=False, verbose_name='카트번호'),
        ),
        migrations.AlterField(
            model_name='cart_info',
            name='owner',
        ...
        migrations.AlterField(
            model_name='item_info',
            name='serial_num',
            field=models.AutoField(default=1, primary_key=True, serialize=False, verbose_name='일련번호'),
        ),
        migrations.AlterField(
            model_name='items',
            name='sort',
        ...
        migrations.AlterField(
            model_name='sex_info',
            name='sex',
            field=models.CharField(default='', max_length=20, primary_key=True, serialize=False, verbose_name='성별'),
        ),
    ]
