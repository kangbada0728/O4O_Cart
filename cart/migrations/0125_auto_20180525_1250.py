...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            name='num',
            field=models.PositiveSmallIntegerField(default=0, verbose_name='개수'),
        ),
        ...
        migrations.AlterField(
            ...
            name='num',
            field=models.PositiveSmallIntegerField(default=0, primary_key=True, serialize=False, verbose_name='추가할 카메라수'),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            model_name='item_info',
            name='serial_num',
            field=models.PositiveIntegerField(default=1, editable=False, primary_key=True, serialize=False, verbose_name='일련번호'),
        ),
        migrations.AlterField(
            model_name='items',
            name='inventory',
